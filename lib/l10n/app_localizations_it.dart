...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get unitTsp => 'cucchiaino';

  @override
  String get unitTbsp => 'cucchiaio';
  ...
  String recipeServings(num count) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$countString porzioni',
      one: '$countString porzione',
    );
    return '$_temp0';
  }
  ...
  @override
  String get metricSatFat => 'Grassi saturi';

  @override
  String get metricSugar => 'Zuccheri';

  @override
  String get metricSalt => 'Sale';

  @override
  String get settingsTrackedNutrients => 'Nutrienti monitorati';

  @override
  String get settingsTrackedNutrientsSub =>
      'Scegli cosa riceve un obiettivo e compare sulla scheda del giorno e nelle tendenze. Le calorie sono sempre attive; disattivando un nutriente i valori restano salvati.';
  ...
  @override
  String get settingsHealthEnergyRead => 'Adatta il budget all\'attività';

  @override
  String settingsHealthEnergyReadSub(String store) {
    return 'Aggiunge le calorie attive da $store all\'obiettivo calorico giornaliero';
  }

  @override
  String get healthEnergyReadOn => 'Aggiustamento attività attivo.';

  @override
  String activityBonus(String kcal) {
    return '+$kcal kcal dall\'attività';
  }

  @override
  String get trendsActivityNote =>
      'La banda dell\'obiettivo non include gli aggiustamenti per l\'attività.';
  ...
  String get captureDescribeSub =>
      'Scrivi cosa hai mangiato — lo stimeremo noi';

  @override
  String get describeMealTitle => 'Descrivi il pasto';

  @override
  String get describeMealLabel => 'Cosa hai mangiato?';

  @override
  String get describeMealExample =>
      'es. 2 fette di pane di segale, burro 10 g, 1 mela';

  @override
  String get describeMealNoLines =>
      'Nessun alimento riconosciuto — scrivi un alimento per riga, meglio con la quantità (es. \"Riso 150 g\").';
  ...
  String shareMeta(int ingredients, num servings, String bytes) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      ingredients,
      locale: localeName,
      other: '$ingredients ingredienti',
      one: '$ingredients ingrediente',
    );
    String _temp1 = intl.Intl.pluralLogic(
      servings,
      locale: localeName,
      other: '$servingsString porzioni',
      one: '$servingsString porzione',
    );
    return '$_temp0 · $_temp1 · $bytes byte';
  }
