...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String recipeServings(num count) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$countString servings',
      one: '$countString serving',
    );
    return '$_temp0';
  }
  ...
  @override
  String get settingsHealthEnergyRead => 'Adjust budget by activity';

  @override
  String settingsHealthEnergyReadSub(String store) {
    return 'Add your active burn from $store to the daily calorie target';
  }

  @override
  String get healthEnergyReadOn => 'Activity adjustment on.';

  @override
  String activityBonus(String kcal) {
    return '+$kcal kcal from activity';
  }
  ...
  @override
  String get aiKeyTest => 'Test key';

  @override
  String get aiKeyTesting => 'Testing…';

  @override
  String get aiKeyTestOk => 'The key works.';
  ...
  @override
  String get a11yMealPhotoOpen => 'Meal photo. Tap to view full screen.';
  ...
  @override
  String get geminiProblemTitle => 'AI estimate didn\'t work';
  ...
  @override
  String get geminiErrorNotFood => 'Gemini didn\'t recognise any food here.';
  ...
  @override
  String get actionContinueManually => 'Continue manually';

  @override
  String get captureDescribe => 'Describe a meal';

  @override
  String get captureDescribeSub => 'Type what you ate — we\'ll estimate it';

  @override
  String get describeMealTitle => 'Describe the meal';

  @override
  String get describeMealLabel => 'What did you eat?';
  ...
  String shareMeta(int ingredients, num servings, String bytes) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$ingredients ingredient',
    );
    String _temp1 = intl.Intl.pluralLogic(
      servings,
      locale: localeName,
      other: '$servingsString servings',
      one: '$servingsString serving',
    );
