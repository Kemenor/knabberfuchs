...
void main() {
  ...
  /// it — the first query runs the v[version] -> latest migration chain.
  ...
  test('v11 -> v12: target columns added, tracked micros backfilled', () async {
    ...
    // Snapshot-only entries with no matching food are untouched (the v13
    // name-match backfill finds no food called 'Quick add' at 150 kcal).
