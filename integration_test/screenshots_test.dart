...
void main() {
  ...
  const strings = <String, Map<String, String>>{
    'breakfast': {
      'en': 'Breakfast 07:42',
      'de': 'Frühstück 07:42',
      'fr': 'Petit-déjeuner 07:42',
      'it': 'Colazione 07:42',
    },
    'lunch': {
      'en': 'Lunch 12:35',
      'de': 'Mittagessen 12:35',
      'fr': 'Déjeuner 12:35',
      'it': 'Pranzo 12:35',
    },
    'greekYogurt': {
    ...
    'milk': {
      'en': 'Milk, semi-skimmed',
      'de': 'Milch, teilentrahmt',
      'fr': 'Lait demi-écrémé',
      'it': 'Latte parzialmente scremato',
    },
    'recipeBowl': {
      'en': 'Chicken rice bowl',
      'de': 'Hähnchen-Reis-Bowl',
      'fr': 'Bowl poulet et riz',
      'it': 'Bowl di pollo e riso',
    },
    'recipeOats': {
      'en': 'Overnight oats',
      'de': 'Overnight Oats',
  ...
  testWidgets('App Store screenshots', (tester) async {
    ...
    await db.createRecipe(
      ...
      [
        RecipeItemsCompanion.insert(
          ...
          grams: 300.0,
          sKcal100: 165.0,
          sProtein100: const Value(31.0),
          sCarb100: const Value(0.0),
          sFat100: const Value(3.6),
        ),
        RecipeItemsCompanion.insert(
          recipeId: 0,
          sName: tr('basmatiRice'),
          grams: 300.0,
          sKcal100: 130.0,
          sProtein100: const Value(2.7),
          sCarb100: const Value(28.0),
          sFat100: const Value(0.3),
        ),
        RecipeItemsCompanion.insert(
          recipeId: 0,
          sName: tr('broccoli'),
          grams: 150.0,
          sKcal100: 34.0,
          sProtein100: const Value(2.8),
          sCarb100: const Value(7.0),
          sFat100: const Value(0.4),
        ),
      ],
    );
    await db.createRecipe(
      ...
      [
        RecipeItemsCompanion.insert(
          ...
          grams: 50.0,
          sKcal100: 389.0,
          sProtein100: const Value(17.0),
          sCarb100: const Value(66.0),
          sFat100: const Value(7.0),
        ),
        RecipeItemsCompanion.insert(
          recipeId: 0,
          sName: tr('milk'),
          grams: 200.0,
          sKcal100: 47.0,
          sProtein100: const Value(3.4),
          sCarb100: const Value(5.0),
          sFat100: const Value(1.5),
        ),
      ],
    );
    ...
    Future<void> tab(HomeTab t) async {
      container.read(homeTabProvider.notifier).set(t);
      await settle(tester);
    }

    Future<void> openSettings() => tab(HomeTab.settings);
